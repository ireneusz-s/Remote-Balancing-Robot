...
#define MPU6050_I2C_ADDR_1			0xD0
#define MPU6050_I2C_ADDR_2			0xD2
...
void IS_MPU6050_ReadGyroscope(IS_MPU6050_struct* DataStruct);
void IS_MPU6050_ReadAccelerometer(IS_MPU6050_struct* DataStruct);
void IS_MPU6050_ReadALL(IS_MPU6050_struct* DataStruct);
